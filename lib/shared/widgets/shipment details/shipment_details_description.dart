...
class ShipmentDetailsDescription extends StatefulWidget {
  ...
  const ShipmentDetailsDescription(
      {super.key,
  ...
  @override
  State<ShipmentDetailsDescription> createState() =>
      _ShipmentDetailsDescriptionState();
}

class _ShipmentDetailsDescriptionState
    extends State<ShipmentDetailsDescription> {
        ...
        Row(
          children: [
            Text(
              ...
              style: TextStyle(
                  color: _textColor.withOpacity(fontOpacity),
            ...
            widget.dateTime != null
                ? Text("${widget.dateTime}",
                    style: TextStyle(
                        color: _textColor.withOpacity(0.3), fontSize: 17))
                : SizedBox.shrink(),
            SizedBox(
              width: 5,
            ),
          ...
          children: [
            ...
            Flexible(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: _iconColor.withOpacity(0.2)),
              ),
            ),
          ],
        ),
