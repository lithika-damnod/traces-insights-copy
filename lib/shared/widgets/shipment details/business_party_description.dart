...
class BusinessPartyDescription extends StatefulWidget {
  ...
  const BusinessPartyDescription(
      {super.key,
  ...
  @override
  State<BusinessPartyDescription> createState() =>
      _BusinessPartyDescriptionState();
}
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 19, color: Colors.white.withOpacity(0.9)),
                    ),
                    Text(
                      "${widget.location} • ${widget.businessType}",
                      style: TextStyle(
